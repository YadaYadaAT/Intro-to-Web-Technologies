...
!function (e, t) {
    ...
    function t(e, t) {
        if (t) for (var i in t.dataset) if (Object.prototype.hasOwnProperty.call(t.dataset, i)) if ("env" === i || "dumpLineNumbers" === i || "rootpath" === i || "errorReporting" === i) e[i] = t.dataset[i]; else try {
    ...
    var i = function (t, i, n) {
        var r = n.href || "", s = "less:" + (n.title || e(r)), o = t.getElementById(s), a = !1,
        ...
        return e.prototype.getFileManager = function (e, t, i, n, s) {
            e || r.warn("getFileManager called with no filename.. Please report this issue. continuing."), void 0 === t && r.warn("getFileManager called with null directory.. Please report this issue. continuing.");
    ...
    }, l = {colors: o, unitConversions: a}, u = function () {
        function e() {
        ...
        return Object.defineProperty(e.prototype, "currentFileInfo", {
            ...
            return void 0 === this.visibilityBlocks && (this.visibilityBlocks = 0), 0 !== this.visibilityBlocks
        }, e.prototype.addVisibilityBlock = function () {
            void 0 === this.visibilityBlocks && (this.visibilityBlocks = 0), this.visibilityBlocks = this.visibilityBlocks + 1
    ...
    c.prototype = Object.assign(new u, {
        type: "Color", luma: function () {
            var e = this.rgb[0] / 255, t = this.rgb[1] / 255, i = this.rgb[2] / 255;
            ...
            if (n = this.fround(e, this.alpha), this.value) if (0 === this.value.indexOf("rgb")) n < 1 && (r = "rgba"); else {
            ...
            var e, t, i = this.rgb[0] / 255, n = this.rgb[1] / 255, r = this.rgb[2] / 255, s = this.alpha,
                o = Math.max(i, n, r), a = Math.min(i, n, r), l = (o + a) / 2, u = o - a;
            if (o === a) e = t = 0; else {
            ...
            var e, t, i = this.rgb[0] / 255, n = this.rgb[1] / 255, r = this.rgb[2] / 255, s = this.alpha,
                o = Math.max(i, n, r), a = Math.min(i, n, r), l = o, u = o - a;
    ...
    d.prototype = Object.assign(new u, {
        type: "Combinator", genCSS: function (e, t) {
    ...
    m.prototype = Object.assign(new u, {
        type: "Element", accept: function (e) {
            ...
            e = e || {};
            var t = this.value, i = e.firstSelector;
    ...
    var g = {ALWAYS: 0, PARENS_DIVISION: 1, PARENS: 2}, y = 0, b = 1, w = 2;
    ...
    var R = Object.freeze({
        ...
        flattenArray: M,
        isNullOrUndefined: E
    }), O = /(<anonymous>|Function):(\d+):(\d+)/, V = function (e, t, i) {
        Error.call(this);
        var n = e.filename || i;
        if (this.message = e.message, this.stack = e.stack, t && n) {
            var r = t.contents[n], s = C(e.index, r), o = s.line, a = s.column, l = e.call && C(e.call, r).line,
                u = r ? r.split("\n") : "";
            if (this.type = e.type || "Syntax", this.filename = n, this.index = e.index, this.line = "number" == typeof o ? o + 1 : null, this.column = a, !this.line && this.stack) {
                var c = this.stack.match(O), h = new Function("a", "throw new Error()"), f = 0;
                try {
                    h()
                } catch (e) {
    ...
    V.prototype.constructor = V, V.prototype.toString = function (e) {
        e = e || {};
        var t = "", i = this.extract || [], n = [], r = function (e) {
            return e
        };
        if (e.stylize) {
    ...
    var N = function () {
            function e(e) {
                this._implementation = e, this._visitInCache = {}, this._visitOutCache = {}, L || (!function e(t, i) {
                    var n, r;
            ...
            return e.prototype.visit = function (e) {
                ...
                if (o.visitDeeper = !0, r || (r = n[i = "visit" + e.type] || j, s = n[i + "Out"] || j, this._visitInCache[t] = r, this._visitOutCache[t] = s), r !== j) {
                    var a = r.call(n, e, o);
                    e && n.isReplacing && (e = a)
                }
                if (o.visitDeeper && e) if (e.length) for (var l = 0, u = e.length; l < u; l++) e[l].accept && e[l].accept(this); else e.accept && e.accept(this);
                ...
                var i, n, r, s, o, a;
                for (t || (t = []), n = 0, i = e.length; n < i; n++) if (void 0 !== (r = e[n])) if (r.splice) for (o = 0, s = r.length; o < s; o++) void 0 !== (a = r[o]) && (a.splice ? a.length && this.flatten(a, t) : t.push(a)); else t.push(r);
                return t
            }, e
        }(), D = {}, B = function (e, t, i) {
            if (e) for (var n = 0; n < i.length; n++) Object.prototype.hasOwnProperty.call(e, i[n]) && (t[i[n]] = e[i[n]])
        },
    ...
    D.Eval = function (e, t) {
        B(e, this, q), "string" == typeof this.paths && (this.paths = [this.paths]), this.frames = t || [], this.importantScope = this.importantScope || []
    ...
    }, D.Eval.prototype.inCalc = !1, D.Eval.prototype.mathOn = !0, D.Eval.prototype.isMathOn = function (e) {
        ...
        var i;
        return t = t || "", i = this.normalizePath(t + e), z(e) && T(t) && !1 === z(i) && (i = "./" + i), i
    ...
    var G = function () {
        ...
        return e.prototype.addImport = function (e) {
            var t = this, i = {callback: e, args: null, isReady: !1};
        ...
        this._visitor = new N(this), this._importer = e, this._finish = t, this.context = new D.Eval, this.importCount = 0, this.onceFileDetectionMap = {}, this.recursionDetector = {}, this._sequencer = new G(this._onSequencerEmpty.bind(this))
    };
    W.prototype = {
        isReplacing: !1, run: function (e) {
            ...
            if (!e.css || i) {
                var n = new D.Eval(this.context, k(this.context.frames)), r = n.frames[0];
            ...
            if (!n || n.css && !r) this.importCount--, this.isFinished && this._sequencer.tryRun(); else {
                ...
                for (var s = void 0 === n.css, o = 0; o < i.rules.length; o++) if (i.rules[o] === e) {
                    i.rules[o] = n;
                    break
                }
                var a = this.onImported.bind(this, n, t), l = this._sequencer.addImport(a);
            ...
            var o = this, a = e.options.inline, l = e.options.isPlugin, u = e.options.optional,
    ...
    var J = function () {
        ...
        return e.prototype.run = function (e) {
            ...
            if (!e.root) {
                var i, n, r, s, o = [], a = e.rules, l = a ? a.length : 0;
                for (i = 0; i < l; i++) e.rules[i] instanceof He.Extend && (o.push(a[i]), e.extendOnEveryPath = !0);
                var u = e.paths;
                for (i = 0; i < u.length; i++) {
                    var c = u[i], h = c[c.length - 1].extendList;
        ...
        return e.prototype.run = function (e) {
            ...
            var n, r, s, o, a, l, u, c, h = [], f = this;
            for (i = i || 0, n = 0; n < e.length; n++) for (r = 0; r < t.length; r++) l = e[n], u = t[r], l.parent_ids.indexOf(u.object_id) >= 0 || (a = [u.selfSelectors[0]], (s = f.findMatch(l, a)).length && (l.hasFoundMatches = !0, l.selfSelectors.forEach((function (e) {
                var t = u.visibilityInfo();
                o = f.extendSelector(s, a, e, l.isVisible()), (c = new He.Extend(u.selector, u.option, 0, u.fileInfo(), t)).selfSelectors = o, o[o.length - 1].extendList = [c], h.push(c), c.ruleset = u.ruleset, c.parent_ids = c.parent_ids.concat(u.parent_ids, l.parent_ids), u.firstExtendOnThisSelectorPath && (c.firstExtendOnThisSelectorPath = !0, u.ruleset.paths.push(o))
            }))));
            if (h.length) {
            ...
            if (!e.root) {
                var i, n, r, s, o = this.allExtendsStack[this.allExtendsStack.length - 1], a = [], l = this;
                for (r = 0; r < o.length; r++) for (n = 0; n < e.paths.length; n++) if (s = e.paths[n], !e.extendOnEveryPath) {
            ...
            var i, n, r, s, o, a, l, u = e.selector.elements, c = [], h = [];
            for (i = 0; i < t.length; i++) for (n = t[i], r = 0; r < n.elements.length; r++) for (s = n.elements[r], (e.allowBefore || 0 === i && 0 === r) && c.push({
                pathIndex: i,
                index: r,
                matched: 0,
            ...
            if (e instanceof He.Attribute) return e.op === t.op && e.key === t.key && (e.value && t.value ? (e = e.value.value || e.value) === (t = t.value.value || t.value) : !e.value && !t.value);
            if (e = e.value, t = t.value, e instanceof He.Selector) {
                if (!(t instanceof He.Selector) || e.elements.length !== t.elements.length) return !1;
            ...
            var r, s, o, a, l, u = 0, c = 0, h = [];
            for (r = 0; r < e.length; r++) s = t[(a = e[r]).pathIndex], o = new He.Element(a.initialCombinator, i.elements[0].value, i.elements[0].isVariable, i.elements[0].getIndex(), i.elements[0].fileInfo()), a.pathIndex > u && c > 0 && (h[h.length - 1].elements = h[h.length - 1].elements.concat(t[u].elements.slice(c)), c = 0, u++), l = s.elements.slice(c, a.index).concat([o]).concat(i.elements.slice(1)), u === a.pathIndex && r > 0 ? h[h.length - 1].elements = h[h.length - 1].elements.concat(l) : (h = h.concat(t.slice(u, a.pathIndex))).push(new He.Selector(l)), u = a.endPathIndex, (c = a.endPathElementIndex) >= t[u].elements.length && (c = 0, u++);
        ...
        return e.prototype.run = function (e) {
            ...
            var i, n = this.contexts[this.contexts.length - 1], r = [];
        ...
        return e.prototype.containsSilentNonBlockedChild = function (e) {
            var t;
            if (!e) return !1;
            for (var i = 0; i < e.length; i++) if ((t = e[i]).isSilent && t.isSilent(this._context) && !t.blocksVisibility()) return !0;
            return !1
            ...
            var t = e.rules[0];
            if (this.keepOnlyVisibleChilds(t), !this.isEmpty(t)) return e.ensureVisibility(), e.removeVisibilityBlock(), e
        }, e.prototype.isVisibleRuleset = function (e) {
            return !!e.firstRoot || !this.isEmpty(e) && !(!e.root && !this.hasVisibleSelector(e))
        }, e
    }(), X = function (e) {
        this._visitor = new N(this), this._context = e, this.utils = new Z(e)
    };
    X.prototype = {
        isReplacing: !0, run: function (e) {
            ...
            if (!e.blocksVisibility()) {
                if ("@charset" === e.name) {
                    if (this.charset) {
                        if (e.debugInfo) {
                            var i = new He.Comment("/* " + e.toCSS(this._context).replace(/\n/g, "") + " */\n");
            ...
            if (e) for (var i = 0; i < e.length; i++) {
                var n = e[i];
                if (t && n instanceof He.Declaration && !n.variable) throw {
                    message: "Properties must be inside selector blocks. They cannot be in the root",
                    index: n.getIndex(),
                    filename: n.fileInfo() && n.fileInfo().filename
                };
                if (n instanceof He.Call) throw {
            ...
            e.paths && (e.paths = e.paths.filter((function (e) {
                var t;
                for (" " === e[0].elements[0].combinator.value && (e[0].elements[0].combinator = new He.Combinator("")), t = 0; t < e.length; t++) if (e[t].isVisible() && e[t].getIsOutput()) return !0;
                return !1
            })))
        }, _removeDuplicateRules: function (e) {
            if (e) {
                var t, i, n, r = {};
                for (n = e.length - 1; n >= 0; n--) if ((i = e[n]) instanceof He.Declaration) if (r[i.name]) {
                    (t = r[i.name]) instanceof He.Declaration && (t = r[i.name] = [r[i.name].toCSS(this._context)]);
            ...
            if (e) {
                ...
                i.forEach((function (e) {
                    if (e.length > 0) {
                        var t = e[0], i = [], n = [new He.Expression(i)];
                        e.forEach((function (e) {
                            "+" === e.merge && i.length > 0 && n.push(new He.Expression(i = [])), i.push(e.value), t.important = t.important || e.important
    ...
    var ee = function () {
        ...
        return l.save = function () {
            ...
            var i = l.i + (t || 0), n = e.charCodeAt(i);
            ...
            for (var i = t.length, n = 0; n < i; n++) if (e.charAt(l.i + n) !== t.charAt(n)) return null;
            return u(i), t
        }, l.$quoted = function (t) {
            var i = t || l.i, n = e.charAt(i);
            if ("'" === n || '"' === n) {
            ...
            var i, n = "", r = null, s = !1, o = 0, a = [], c = [], h = e.length, f = l.i, p = l.i, v = l.i, d = !0;
            ...
            do {
                var m = e.charAt(v);
                if (0 === o && i(m)) (r = e.substr(p, v - p)) ? c.push(r) : c.push(" "), r = c, u(v - f), d = !1; else {
                    if (s) {
            ...
            e = n, l.i = t = o = i = 0, r = a ? function (e, t) {
                var i, n, r, s, o, a, l, u, c, h = e.length, f = 0, p = 0, v = [], d = 0;
                ...
                for (o = 0; o < h; o++) if (!((l = e.charCodeAt(o)) >= 97 && l <= 122 || l < 34)) switch (l) {
                    case 40:
                        p++, n = o;
                        continue;
                    case 41:
                    ...
                    case 39:
                    case 96:
                        for (c = 0, a = o, o += 1; o < h; o++) if (!((u = e.charCodeAt(o)) > 96)) {
                            if (u == l) {
                                c = 1;
                                break
                            }
                    ...
                    case 47:
                        if (p || o == h - 1) continue;
                        if (47 == (u = e.charCodeAt(o + 1))) for (o += 2; o < h && (!((u = e.charCodeAt(o)) <= 13) || 10 != u && 13 != u); o++) ; else if (42 == u) {
    ...
    var te = function e(t) {
    ...
    }(null), ie = {queryInParens: !0}, ne = {queryInParens: !0}, re = function e(t, i, n, r) {
        var s;
        r = r || 0;
        var o = ee();

        function a(e, t) {
            throw new V({index: o.i, filename: n.filename, type: t || "Syntax", message: e}, i)
        }

        function l(e, t) {
            var i = e instanceof Function ? e.call(s) : o.$re(e);
            if (i) return i;
            a(t || ("string" == typeof e ? "expected '" + e + "' got '" + o.currentChar() + "'" : "unexpected token"))
        }
        ...
        return {
            parserInput: o, imports: i, fileInfo: n, parseNode: function (e, t, a) {
                var l, u = [], c = o;
                try {
                    c.start(e, !1, (function (e, t) {
                        a({message: e, index: t + r})
                    }));
                    for (var h = 0, f = void 0; f = t[h]; h++) l = s[f](), u.push(l || null);
                    c.end().isFinished ? a(null, u) : a(!0, null)
                } catch (e) {
                    throw new V({index: e.index + r, message: e.message}, i, n.filename)
                }
            }, parse: function (r, l, u) {
                var c, h, f, p, v = null, d = "";
                if (u && u.disablePluginRule && (s.plugin = function () {
                    o.$re(/^@plugin?\s+/) && a("@plugin statements are not allowed when disablePluginRule is set to true")
                }), h = u && u.globalVars ? e.serializeVars(u.globalVars) + "\n" : "", f = u && u.modifyVars ? "\n" + e.serializeVars(u.modifyVars) : "", t.pluginManager) for (var m = t.pluginManager.getPreProcessors(), g = 0; g < m.length; g++) r = m[g].process(r, {
                    context: t,
                    imports: i,
                    fileInfo: n
                });
                (h || u && u.banner) && (d = (u && u.banner ? u.banner : "") + h, (p = i.contentsIgnoredChars)[n.filename] = p[n.filename] || 0, p[n.filename] += d.length), r = d + (r = r.replace(/\r\n?/g, "\n")).replace(/^\uFEFF/, "") + f, i.contents[n.filename] = r;
                try {
                    o.start(r, t.chunkInput, (function (e, t) {
                        throw new V({index: t, type: "Parse", message: e, filename: n.filename}, i)
                    })), He.Node.prototype.parse = this, c = new He.Ruleset(null, this.parsers.primary()), He.Node.prototype.rootNode = c, c.root = !0, c.firstRoot = !0, c.functionRegistry = te.inherit()
                } catch (e) {
                ...
                if (!y.isFinished) {
                    ...
                    b || (b = "Unrecognised input", "}" === y.furthestChar ? b += ". Possibly missing opening '{'" : ")" === y.furthestChar ? b += ". Possibly missing opening '('" : y.furthestReachedEnd && (b += ". Possibly missing something")), v = new V({
                        type: "Parse",
                        message: b,
                        index: y.furthest,
                        filename: n.filename
                ...
                var w = function (e) {
                    return (e = v || e || i.error) ? (e instanceof V || (e = new V(e, i, n.filename)), l(e)) : l(null, c)
                };
                ...
                primary: function () {
                    ...
                    mixinLookup: function () {
                        ...
                        var t, i = o.i, s = !1;
                        if (o.save(), o.$char("~")) s = !0; else if (e) return void o.restore();
                        if (t = o.$quoted()) return o.forget(), new He.Quoted(t.charAt(0), t.substr(1, t.length - 2), s, i + r, n);
                        o.restore()
                    }, keyword: function () {
                        ...
                        if (!o.peek(/^url\(/i)) if (o.save(), e = o.$re(/^([\w-]+|%|~|progid:[\w.]+)\(/)) {
                            if (e = e[1], (i = this.customFuncCall(e)) && (t = i.parse()) && i.stop) return o.forget(), t;
                            if (t = this.arguments(t), o.$char(")")) return o.forget(), new He.Call(e, t, s + r, n);
                            o.restore("Could not parse call arguments or missing ')'")
                        } else o.forget()
                    }, customFuncCall: function (e) {
                        return {alpha: t(s.ieAlpha, !0), boolean: t(i), if: t(i)}[e.toLowerCase()];
                        ...
                        for (o.save(); ;) {
                            if (e) e = !1; else {
                                if (!(i = s.detachedRuleset() || this.assignment() || s.expression())) break;
                                i.value && 1 == i.value.length && (i = i.value[0]), n.push(i)
                            }
                            o.$char(",") || (o.$char(";") || t) && (t = !0, i = n.length < 1 ? n[0] : new He.Value(n), r.push(i), n = [])
                        }
                        ...
                        if (o.save(), e = o.$re(/^\w+(?=\s?=)/i)) if (o.$char("=")) {
                            if (t = s.entity()) return o.forget(), new He.Assignment(e, t);
                            o.restore()
                        } else o.restore(); else o.restore()
                    }, url: function () {
                        var e, t = o.i;
                        if (o.autoCommentAbsorb = !1, o.$str("url(")) return e = this.quoted() || this.variable() || this.property() || o.$re(/^(?:(?:\\[()'"])|[^()'"])+/) || "", o.autoCommentAbsorb = !0, u(")"), new He.URL(void 0 !== e.value || e instanceof He.Variable || e instanceof He.Property ? e : new He.Anonymous(e, t), t + r, n);
                        ...
                        var e, t = o.i;
                        if ("@" === o.currentChar() && (e = o.$re(/^@\{([\w-]+)\}/))) return new He.Variable("@" + e[1], t + r, n)
                    }, property: function () {
                        var e, t = o.i;
                        if ("$" === o.currentChar() && (e = o.$re(/^\$[\w-]+/))) return new He.Property(e, t + r, n)
                    }, propertyCurly: function () {
                        var e, t = o.i;
                        if ("$" === o.currentChar() && (e = o.$re(/^\$\{([\w-]+)\}/))) return new He.Property("$" + e[1], t + r, n)
                    }, color: function () {
                        var e;
                        if (o.save(), "#" === o.currentChar() && (e = o.$re(/^#([A-Fa-f0-9]{8}|[A-Fa-f0-9]{6}|[A-Fa-f0-9]{3,4})([\w.#[])?/)) && !e[2]) return o.forget(), new He.Color(e[1], void 0, e[0]);
                        o.restore()
                        ...
                        var e;
                        if (e = o.$re(/^U\+[0-9a-fA-F?]+(-[0-9a-fA-F?]+)?/)) return new He.UnicodeDescriptor(e[0])
                    }, javascript: function () {
                        var e, t = o.i;
                        o.save();
                        var i = o.$char("~");
                        if (o.$char("`")) {
                            if (e = o.$re(/^[^`]*`/)) return o.forget(), new He.JavaScript(e.substr(0, e.length - 1), Boolean(i), t + r, n);
                    ...
                    if (o.save(), a || "@" === o.currentChar() && (a = o.$re(/^(@[\w-]+)(\(\s*\))?/))) {
                        if (!(t = this.mixin.ruleLookups()) && (r && "()" !== o.$str("()") || "()" !== a[2])) return void o.restore("Missing '[...]' lookup in variable call");
                        r || (a = a[1]);
                        var l = new He.VariableCall(a, i, n);
                        return !r && s.end() ? (o.forget(), l) : (o.forget(), new He.NamespaceValue(l, t, i, n))
                    }
                    o.restore()
                }, extend: function (e) {
                    var t, i, s, u, c, h = o.i;
                    if (o.$str(e ? "&:extend(" : ":extend(")) {
                        do {
                            for (s = null, t = null; !(s = o.$re(/^(all)(?=\s*(\)|,))/)) && (i = this.element());) t ? t.push(i) : t = [i];
                            s = s && s[1], t || a("Missing target selector for :extend()."), c = new He.Extend(new He.Selector(t), s, h + r, n), u ? u.push(c) : u = [c]
                        } while (o.$char(","));
                        return l(/^\)/), e && l(/^;/), u
                    }
                }, extendRule: function () {
                    ...
                    call: function (e, t) {
                        var i, a, l, c, h = o.currentChar(), f = !1, p = o.i;
                        if ("." === h || "#" === h) {
                            if (o.save(), a = this.elements()) {
                                if (o.$char("(") && (l = this.args(!0).args, u(")"), c = !0), !1 !== t && (i = this.ruleLookups()), !0 === t && !i) return void o.restore();
                        ...
                        for (var e, t, i, s, a, l = /^[#.](?:[\w-]|\\(?:[A-Fa-f0-9]{1,6} ?|[^A-Fa-f0-9]))+/; a = o.i, t = o.$re(l);) s = new He.Element(i, t, !1, a + r, n), e ? e.push(s) : e = [s], i = o.$char(">");
                        return e
                    }, args: function (e) {
                        var t, i, n, r, l, u, c, h = s.entities, f = {args: null, variadic: !1}, p = [], v = [], d = [],
                            m = !0;
                        for (o.save(); ;) {
                            if (e) u = s.detachedRuleset() || s.expression(); else {
                            ...
                            if (!u || !m) break;
                            r = null, u.throwAwayComments && u.throwAwayComments(), l = u;
                            var g = null;
                            if (e ? u.value && 1 == u.value.length && (g = u.value[0]) : g = u, g && (g instanceof He.Variable || g instanceof He.Property)) if (o.$char(":")) {
                                if (p.length > 0 && (t && a("Cannot mix ; and , as delimiter types"), i = !0), !(l = s.detachedRuleset() || s.expression())) {
                            ...
                            l && p.push(l), d.push({
                                ...
                                value: l,
                                expand: c
                            }), o.$char(",") ? m = !0 : ((m = ";" === o.$char(";")) || t) && (i && a("Cannot mix ; and , as delimiter types"), t = !0, p.length > 1 && (l = new He.Value(p)), v.push({
                                name: n,
                                value: l,
                                expand: c
                            }), n = null, p = [], i = !1)
                        ...
                        if (!("." !== o.currentChar() && "#" !== o.currentChar() || o.peek(/^[^{]*\}/))) if (o.save(), t = o.$re(/^([#.](?:[\w-]|\\(?:[A-Fa-f0-9]{1,6} ?|[^A-Fa-f0-9]))+)\s*\(/)) {
                            e = t[1];
                            var u = this.args(!1);
                            if (r = u.args, a = u.variadic, !o.$char(")")) return void o.restore("Missing closing ')'");
                            if (o.commentStore.length = 0, o.$str("when") && (n = l(s.conditions, "expected condition")), i = s.block()) return o.forget(), new He.mixin.Definition(e, r, i, n, a);
                            o.restore()
                        } else o.restore()
                    ...
                    var e;
                    if (o.$re(/^opacity=/i)) return (e = o.$re(/^\d+/)) || (e = "@{" + (e = l(s.entities.variable, "Could not parse alpha")).name.slice(1) + "}"), u(")"), new He.Quoted("", "alpha(opacity=" + e + ")")
                }, element: function () {
                    var e, t, i, s = o.i;
                    if (t = this.combinator(), (e = o.$re(/^(?:\d+\.\d+|\d+)%/) || o.$re(/^(?:[.#]?|:*)(?:[\w-]|[^\x00-\x9f]|\\(?:[A-Fa-f0-9]{1,6} ?|[^A-Fa-f0-9]))+/) || o.$char("*") || o.$char("&") || this.attribute() || o.$re(/^\([^&()@]+\)/) || o.$re(/^[.#:](?=@)/) || this.entities.variableCurly()) || (o.save(), o.$char("(") ? (i = this.selector(!1)) && o.$char(")") ? (e = new He.Paren(i), o.forget()) : o.restore("Missing closing ')'") : o.forget()), e) return new He.Element(t, e, e instanceof He.Variable, s + r, n)
                }, combinator: function () {
                    var e = o.currentChar();
                    if ("/" === e) {
                        o.save();
                    ...
                    return o.isWhitespace(-1) ? new He.Combinator(" ") : new He.Combinator(null)
                }, selector: function (e) {
                    var t, i, s, u, c, h, f, p = o.i;
                    for (e = !1 !== e; (e && (i = this.extend()) || e && (h = o.$str("when")) || (u = this.element())) && (h ? f = l(this.conditions, "expected condition") : f ? a("CSS guard can only be used at the end of selector") : i ? c = c ? c.concat(i) : i : (c && a("Extend can only be used at the end of selector"), s = o.currentChar(), t ? t.push(u) : t = [u], u = null), "{" !== s && "}" !== s && ";" !== s && "," !== s && ")" !== s);) ;
                    if (t) return new He.Selector(t, c, f, p + r, n);
                    c && a("Extend must be used to extend a selector, it cannot be used on its own")
                }, selectors: function () {
                    for (var e, t; (e = this.selector()) && (t ? t.push(e) : t = [e], o.commentStore.length = 0, e.condition && t.length > 1 && a("Guards are only currently allowed on a single selector."), o.$char(","));) e.condition && a("Guards are only currently allowed on a single selector."), o.commentStore.length = 0;
                    return t
                }, attribute: function () {
                    if (o.$char("[")) {
                        var e, t, i, n, r = this.entities;
                        return (e = r.variableCurly()) || (e = l(/^(?:[_A-Za-z0-9-*]*\|)?(?:[_A-Za-z0-9-]|\\.)+/)), (i = o.$re(/^[|~*$^]?=/)) && (t = r.quoted() || o.$re(/^[0-9]+%/) || o.$re(/^[\w-]+/) || r.variableCurly()) && (n = o.$re(/^[iIsS]/)), u("]"), new He.Attribute(e, i, t, n)
                    }
                }, block: function () {
                    var e;
                    ...
                    var e, t, i;
                    if (o.save(), !o.$re(/^[.#]\(/) || (t = (e = this.mixin.args(!1)).args, i = e.variadic, o.$char(")"))) {
                        var n = this.blockRuleset();
                        if (n) return o.forget(), t ? new He.mixin.Definition(null, t, n, null, i) : new He.DetachedRuleset(n);
                        o.restore()
                    } else o.restore()
                }, ruleset: function () {
                    var e, i, n;
                    if (o.save(), t.dumpLineNumbers && (n = c(o.i)), (e = this.selectors()) && (i = this.block())) {
                        o.forget();
                    ...
                    var e, t, i, s, a, l, u = o.i, c = o.currentChar();
                    if ("." !== c && "#" !== c && "&" !== c && ":" !== c) if (o.save(), e = this.variable() || this.ruleProperty()) {
                        if ((l = "string" == typeof e) && (t = this.detachedRuleset()) && (i = !0), o.commentStore.length = 0, !t) {
                            if (a = !l && e.length > 1 && e.pop().value, t = e[0].value && "--" === e[0].value.slice(0, 2) ? this.permissiveValue(/[;}]/) : this.anonymousValue()) return o.forget(), new He.Declaration(e, t, !1, a, u + r, n);
                            t || (t = this.value()), t ? s = this.important() : l && (t = this.permissiveValue())
                        }
                        if (t && (this.end() || i)) return o.forget(), new He.Declaration(e, t, s, a, u + r, n);
                        o.restore()
                    } else o.restore()
                    ...
                    if (!h()) {
                        ...
                        if (r = h(), s.length > 0) {
                            ...
                            c.push(s), " " === o.prevChar() && c.push(new He.Anonymous(" ", u))
                        }
                        if (o.save(), s = o.$parseUntil(l)) {
                            if ("string" == typeof s && a("Expected '" + s + "'", "Parse"), 1 === s.length && " " === s[0]) return o.forget(), new He.Anonymous("", u);
                            var f = void 0;
                            for (t = 0; t < s.length; t++) if (f = s[t], Array.isArray(f)) c.push(new He.Quoted(f[0], f[1], !0, u, n)); else {
                    ...
                    var e, t, i = o.i, s = o.$re(/^@import\s+/);
                    if (s) {
                        var l = (s ? this.importOptions() : null) || {};
                        if (e = this.entities.quoted() || this.entities.url()) return t = this.mediaFeatures({}), o.$char(";") || (o.i = i, a("missing semi-colon or unrecognised media features on import")), t = t && new He.Value(t), new He.Import(e, t, l, i + r, n);
                    ...
                    var t, i, s, l = this.entities, u = [];
                    o.save();
                    do {
                        (t = l.keyword() || l.variable() || l.mixinLookup()) ? u.push(t) : o.$char("(") && (i = this.property(), o.save(), !i && e.queryInParens && o.$re(/^[0-9a-z-]*\s*([<>]=|<=|>=|[<>]|=)/) ? (o.restore(), i = this.condition(), o.save(), (s = this.atomicCondition(null, i.rvalue)) || o.restore()) : (o.restore(), t = this.value()), o.$char(")") ? i && !t ? (u.push(new He.Paren(new He.QueryInParens(i.op, i.lvalue, i.rvalue, s ? s.op : null, s ? s.rvalue : null, i._index))), t = i) : i && t ? u.push(new He.Paren(new He.Declaration(i, t, null, null, o.i + r, n, !0))) : t ? u.push(new He.Paren(t)) : a("badly formed media feature definition") : a("Missing closing ')'", "Parse"))
                    } while (t);
                    if (o.forget(), u.length > 0) return new He.Expression(u)
                }, mediaFeatures: function (e) {
                    var t, i = this.entities, n = [];
                    do {
                        if (t = this.mediaFeature(e)) {
                            if (n.push(t), !o.$char(",")) break
                        } else if ((t = i.variable() || i.mixinLookup()) && (n.push(t), !o.$char(","))) break
                    } while (t);
                    return n.length > 0 ? n : null
                }, prepareAndGetNestableAtRule: function (e, i, s, l) {
                    var u = this.mediaFeatures(l), c = this.block();
                    c || a("media definitions require block statements after any features"), o.forget();
                    ...
                    if (t.dumpLineNumbers && (e = c(i)), o.save(), o.$peekChar("@")) {
                        if (o.$str("@media")) return this.prepareAndGetNestableAtRule(He.Media, i, e, ie);
                        if (o.$str("@container")) return this.prepareAndGetNestableAtRule(He.Container, i, e, ne)
                    }
                    o.restore()
                }, plugin: function () {
                    var e, t, i, s = o.i;
                    if (o.$re(/^@plugin\s+/)) {
                        if (i = (t = this.pluginArgs()) ? {
                            pluginArgs: t,
                            isPlugin: !0
                        } : {isPlugin: !0}, e = this.entities.quoted() || this.entities.url()) return o.$char(";") || (o.i = s, a("missing semi-colon on @plugin")), new He.Import(e, null, i, s + r, n);
                    ...
                    var e, i, s, l, u, h, f, p = o.i, v = !0, d = !0;
                    if ("@" === o.currentChar()) {
                        if (i = this.import() || this.plugin() || this.nestableAtRule()) return i;
                        if (o.save(), e = o.$re(/^@[a-z-]+/)) {
                            switch (l = e, "-" == e.charAt(1) && e.indexOf("-", 2) > 0 && (l = "@" + e.slice(e.indexOf("-", 2) + 1)), l) {
                                case"@charset":
                                    u = !0, v = !1;
                                    break;
                                case"@namespace":
                    ...
                    var e, t;
                    if (o.save(), o.$char("(")) return (e = this.addition()) && o.$char(")") ? (o.forget(), (t = new He.Expression([e])).parens = !0, t) : void o.restore("Expected ')'");
                    o.restore()
                }, multiplication: function () {
                    var e, t, i, n, r;
                    if (e = this.operand()) {
                        for (r = o.isWhitespace(-1); !o.peek(/^\/[*/]/);) {
                            if (o.save(), !(i = o.$char("/") || o.$char("*") || o.$str("./"))) {
                                o.forget();
                                break
                            }
                            if (!(t = this.operand())) {
                            ...
                            o.forget(), e.parensInOp = !0, t.parensInOp = !0, n = new He.Operation(i, [n || e, t], r), r = o.isWhitespace(-1)
                        }
                        return n || e
                    }
                }, addition: function () {
                    ...
                    if (e = this.multiplication()) {
                        for (r = o.isWhitespace(-1); (i = o.$re(/^[-+]\s+/) || !r && (o.$char("+") || o.$char("-"))) && (t = this.multiplication());) e.parensInOp = !0, t.parensInOp = !0, n = new He.Operation(i, [n || e, t], r), r = o.isWhitespace(-1);
                        return n || e
                    }
                }, conditions: function () {
                    var e, t, i, n = o.i;
                    if (e = this.condition(!0)) {
                        for (; o.peek(/^,\s*(not\s*)?\(/) && o.$char(",") && (t = this.condition(!0));) i = new He.Condition("or", i || e, t, n + r);
                        return i || e
                    }
                    ...
                    var i, n, s, l, u = this.entities, c = o.i, h = function () {
                        return this.addition() || u.keyword() || u.quoted() || u.mixinLookup()
                    }.bind(this);
                    if (i = t || h()) return o.$char(">") ? l = o.$char("=") ? ">=" : ">" : o.$char("<") ? l = o.$char("=") ? "<=" : "<" : o.$char("=") && (l = o.$char(">") ? "=>" : o.$char("<") ? "=<" : "="), l ? (n = h()) ? s = new He.Condition(l, i, n, c + r, !1) : a("expected expression") : t || (s = new He.Condition("=", i, new He.Keyword("true"), c + r, !1)), s
                }, operand: function () {
                    ...
                    var e, t, i = [], n = o.i;
                    do {
                        (e = this.comment()) ? i.push(e) : ((e = this.addition() || this.entity()) instanceof He.Comment && (e = null), e && (i.push(e), o.peek(/^\/[/*]/) || (t = o.$char("/")) && i.push(new He.Anonymous(t, n + r))))
                    } while (e);
                    ...
                    for (l(/^(\*?)/); l(/^((?:[\w-]+)|(?:[@$]\{[\w-]+\}))/);) ;
                    if (i.length > 1 && l(/^((?:\+_|\+)?)\s*:/)) {
                        for (o.forget(), "" === i[0] && (i.shift(), s.shift()), t = 0; t < i.length; t++) e = i[t], i[t] = "@" !== e.charAt(0) && "$" !== e.charAt(0) ? new He.Keyword(e) : "@" === e.charAt(0) ? new He.Variable("@" + e.slice(2, -1), s[t] + r, n) : new He.Property("$" + e.slice(2, -1), s[t] + r, n);
                        return i
                    }
                    o.restore()
                }
    ...
    se.prototype = Object.assign(new u, {
        type: "Selector", accept: function (e) {
            ...
            var n = new se(e, t || this.extendList, null, this.getIndex(), this.fileInfo(), this.visibilityInfo());
            return n.evaldCondition = E(i) ? this.evaldCondition : i, n.mediaEmpty = this.mediaEmpty, n
        }, getElements: function (e) {
            return e ? ("string" == typeof e && new re(this.parse.context, this.parse.importManager, this._fileInfo, this._index).parseNode(e, ["selector"], (function (t, i) {
                if (t) throw new V({index: t.index, message: t.message}, this.parse.imports, this._fileInfo.filename);
                e = i[0].elements
            ...
            var t, i, n = this.elements, r = n.length;
            ...
            var t = this.condition && this.condition.eval(e), i = this.elements, n = this.extendList;
    ...
    oe.prototype = Object.assign(new u, {
        type: "Value", accept: function (e) {
            ...
            return 1 === this.value.length ? this.value[0].eval(e) : new oe(this.value.map((function (t) {
                return t.eval(e)
            })))
        }, genCSS: function (e, t) {
            var i;
    ...
    ae.prototype = Object.assign(new u, {
        type: "Keyword", genCSS: function (e, t) {
            if ("%" === this.value) throw {type: "Syntax", message: "Invalid % without number"};
            t.add(this.value)
        }
    }), ae.True = new ae("true"), ae.False = new ae("false");
    ...
    le.prototype = Object.assign(new u, {
        type: "Anonymous", eval: function () {
            return new le(this.value, this._index, this._fileInfo, this.mapLines, this.rulesetLike, this.visibilityInfo())
        }, compare: function (e) {
    ...
    var ce = function (e, t, i, n, r, s, o, a) {
        this.name = e, this.value = t instanceof u ? t : new oe([t ? new le(t) : null]), this.important = i ? " " + i.trim() : "", this.merge = n, this._index = r, this._fileInfo = s, this.inline = o || !1, this.variable = void 0 !== a ? a : e.charAt && "@" === e.charAt(0), this.allowRoot = !0, this.setParent(this.value, this)
    };
    ...
    ce.prototype = Object.assign(new u, {
        type: "Declaration", genCSS: function (e, t) {
            ...
            var t, i, n = !1, r = this.name, s = this.variable;
            "string" != typeof r && (r = 1 === r.length && r[0] instanceof ae ? r[0].value : function (e, t) {
                ...
                return n
            }(e, r), s = !1), "font" === r && e.math === ue.ALWAYS && (n = !0, t = e.math, e.math = ue.PARENS_DIVISION);
            try {
                ...
                var o = this.important, a = e.importantScope.pop();
                return !o && a.important && (o = a.important), new ce(r, i, o, this.merge, this.getIndex(), this.fileInfo(), this.inline, s)
            } catch (e) {
            ...
            return new ce(this.name, this.value, "!important", this.merge, this.getIndex(), this.fileInfo(), this.inline)
        }
    });
    ...
    ve.prototype = Object.assign(new u, {
        type: "Comment", genCSS: function (e, t) {
            this.debugInfo && t.add(pe(e, this), this.fileInfo(), this.getIndex()), t.add(this.value)
        }, isSilent: function (e) {
    ...
    me.prototype = Object.assign(new u, {
        type: "Ruleset", isRuleset: !0, isRulesetLike: function () {
            return !0
        }, accept: function (e) {
            ...
            if (this.selectors && (i = this.selectors.length)) {
                for (t = new Array(i), de.error({
                    type: "Syntax",
                    message: "it is currently only allowed in parametric mixin guards,"
                }), r = 0; r < i; r++) {
                    n = this.selectors[r].eval(e);
                    for (var a = 0; a < n.elements.length; a++) if (n.elements[a].isVariable) {
                        s = !0;
                        break
                    }
                ...
                if (s) {
                    ...
                    var c = t[0].getIndex(), h = t[0].fileInfo();
                    new re(e, this.parse.importManager, h, c).parseNode(l.join(","), ["selectors"], (function (e, i) {
                        i && (t = M(i))
                    }))
                }
                de.reset()
            } else o = !0;
            var f, p, v = this.rules ? k(this.rules) : null,
                d = new me(t, v, this.strictImports, this.visibilityInfo());
            d.originalRuleset = this, d.root = this.root, d.firstRoot = this.firstRoot, d.allowImports = this.allowImports, this.debugInfo && (d.debugInfo = this.debugInfo), o || (v.length = 0), d.functionRegistry = function (e) {
            ...
            m.unshift(d);
            var g = e.selectors;
            g || (e.selectors = g = []), g.unshift(this.selectors), (d.root || d.allowImports || !d.strictImports) && d.evalImports(e);
            var y = d.rules;
            for (r = 0; f = y[r]; r++) f.evalFirst && (y[r] = f.eval(e));
            var b = e.mediaBlocks && e.mediaBlocks.length || 0;
            for (r = 0; f = y[r]; r++) "MixinCall" === f.type ? (v = f.eval(e).filter((function (e) {
                return !(e instanceof ce && e.variable) || !d.variable(e.name)
            })), y.splice.apply(y, [r, 1].concat(v)), r += v.length - 1, d.resetCache()) : "VariableCall" === f.type && (v = f.eval(e).rules.filter((function (e) {
                return !(e instanceof ce && e.variable)
            })), y.splice.apply(y, [r, 1].concat(v)), r += v.length - 1, d.resetCache());
            for (r = 0; f = y[r]; r++) f.evalFirst || (y[r] = f = f.eval ? f.eval(e) : f);
            for (r = 0; f = y[r]; r++) if (f instanceof me && f.selectors && 1 === f.selectors.length && f.selectors[0] && f.selectors[0].isJustParentSelector()) {
                y.splice(r--, 1);
                for (a = 0; p = f.rules[a]; a++) p instanceof u && (p.copyVisibilityInfo(f.visibilityInfo()), p instanceof ce && p.variable || y.splice(++r, 0, p))
            }
            if (m.shift(), g.shift(), e.mediaBlocks) for (r = b; r < e.mediaBlocks.length; r++) e.mediaBlocks[r].bubbleSelectors(t);
            return d
        }, evalImports: function (e) {
            var t, i, n = this.rules;
            if (n) for (t = 0; t < n.length; t++) "Import" === n[t].type && ((i = n[t].eval(e)) && (i.length || 0 === i.length) ? (n.splice.apply(n, [t, 1].concat(i)), t += i.length - 1) : n.splice(t, 1, i), this.resetCache())
        }, makeImportant: function () {
            return new me(this.selectors, this.rules.map((function (e) {
            ...
            return !!i.evaldCondition && !(i.condition && !i.condition.eval(new D.Eval(t, t.frames)))
        }, resetCache: function () {
            ...
            return this._variables || (this._variables = this.rules ? this.rules.reduce((function (e, t) {
                if (t instanceof ce && !0 === t.variable && (e[t.name] = t), "Import" === t.type && t.root && t.root.variables) {
            ...
            return this._properties || (this._properties = this.rules ? this.rules.reduce((function (e, t) {
                if (t instanceof ce && !0 !== t.variable) {
                    var i = 1 === t.name.length && t.name[0] instanceof ae ? t.name[0].value : t.name;
            ...
            function i(e) {
                return e.value instanceof le && !e.parsed ? ("string" == typeof e.value.value ? new re(this.parse.context, this.parse.importManager, e.fileInfo(), e.value.getIndex()).parseNode(e.value.value, ["value", "important"], (function (t, i) {
            ...
            return o in this._lookups ? this._lookups[o] : (this.rulesets().forEach((function (o) {
                if (o !== t) for (var a = 0; a < o.selectors.length; a++) if (n = e.match(o.selectors[a])) {
            ...
            for (i = 0; s = this.rules[i]; i++) s instanceof ve ? (f === i && f++, a.push(s)) : s.isCharset && s.isCharset() ? (a.splice(h, 0, s), h++, f++) : "Import" === s.type ? (a.splice(f, 0, s), f++) : a.push(s);
            if (a = [].concat(a), !this.root) {
                (r = pe(e, this, c)) && (t.add(r), t.add(c));
                var p = this.paths, v = p.length, d = void 0;
                for (l = e.compress ? "," : ",\n" + c, i = 0; i < v; i++) if (d = (o = p[i]).length) for (i > 0 && t.add(l), e.firstSelector = !0, o[0].genCSS(e, t), e.firstSelector = !1, n = 1; n < d; n++) o[n].genCSS(e, t);
                t.add((e.compress ? "{" : " {\n") + u)
            }
            for (i = 0; s = a[i]; i++) {
            ...
            function n(e, t) {
                var i, n;
                if (0 === e.length) i = new p(e[0]); else {
            ...
            function r(e, t) {
                var i;
                return i = new m(null, e, t.isVariable, t._index, t._fileInfo), new se([i])
            }

            function s(e, t, i, n) {
                var r, s, o;
                if (r = [], e.length > 0 ? (s = (r = k(e)).pop(), o = n.createDerived(k(s.elements))) : o = n.createDerived([]), t.length > 0) {
                    var a = i.combinator, l = t[0].elements[0];
            ...
            function a(e, t) {
                var i, n;
                if (0 !== e.length) if (0 !== t.length) for (i = 0; n = t[i]; i++) n.length > 0 ? n[n.length - 1] = n[n.length - 1].createDerived(n[n.length - 1].elements.concat(e)) : n.push(new se(e)); else t.push([new se(e)])
            }
            ...
            if (!function e(t, i, l) {
                ...
                for (f = [], v = [[]], u = 0; y = l.elements[u]; u++) if ("&" !== y.value) {
                    var C = (S = void 0, (x = y).value instanceof p && (S = x.value.value) instanceof se ? S : null);
                    if (null !== C) {
                        a(f, v);
                        var k, _ = [], A = [];
                    ...
                    for (I = !0, d = [], a(f, v), c = 0; c < v.length; c++) if (g = v[c], 0 === i.length) g.length > 0 && g[0].elements.push(new m(y.combinator, "", y.isVariable, y._index, y._fileInfo)), d.push(g); else for (h = 0; h < i.length; h++) {
                        var P = s(g, i[h], y, l);
                        d.push(P)
                    }
                    v = d, f = []
                ...
                return I
            }(c = [], t, i)) if (t.length > 0) for (c = [], u = 0; u < t.length; u++) {
    ...
    var ge = function (e, t, i, n, r, s, o, a) {
        var l;
        if (this.name = e, this.value = t instanceof u ? t : t ? new le(t) : t, i) {
            for (Array.isArray(i) ? this.rules = i : (this.rules = [i], this.rules[0].selectors = new se([], null, null, n, r).createEmptySelectors()), l = 0; l < this.rules.length; l++) this.rules[l].allowImports = !0;
    ...
    ge.prototype = Object.assign(new u, {
        type: "AtRule", accept: function (e) {
            var t = this.value, i = this.rules;
            ...
            var i = this.value, n = this.rules;
            t.add(this.name, this.fileInfo(), this.getIndex()), i && (t.add(" "), i.genCSS(e, t)), n ? this.outputRuleset(e, t, n) : t.add(";")
        }, eval: function (e) {
            var t, i, n = this.value, r = this.rules;
            return t = e.mediaPath, i = e.mediaBlocks, e.mediaPath = [], e.mediaBlocks = [], n && (n = n.eval(e)), r && ((r = [r[0].eval(e)])[0].root = !0), e.mediaPath = t, e.mediaBlocks = i, new ge(this.name, n, r, this.getIndex(), this.fileInfo(), this.debugInfo, this.isRooted, this.visibilityInfo())
        }, variable: function (e) {
    ...
    ye.prototype = Object.assign(new u, {
        type: "DetachedRuleset", evalFirst: !0, accept: function (e) {
            this.ruleset = e.visit(this.ruleset)
        }, eval: function (e) {
            var t = this.frames || k(e.frames);
            return new ye(this.ruleset, t)
        }, callEval: function (e) {
            return this.ruleset.eval(this.frames ? new D.Eval(e, this.frames.concat(e.frames)) : e)
        }
    });
    ...
    be.prototype = Object.assign(new u, {
        type: "Unit", clone: function () {
            ...
            for (e in this.numerator = [], this.denominator = [], i) if (i.hasOwnProperty(e)) {
                var n = i[e];
                if (n > 0) for (t = 0; t < n; t++) this.numerator.push(e); else if (n < 0) for (t = 0; t < -n; t++) this.denominator.push(e)
            }
    ...
    var we = function (e, t) {
        ...
        this.unit = t && t instanceof be ? t : new be(t ? [t] : void 0), this.setParent(this.unit, this)
    };
    we.prototype = Object.assign(new u, {
        type: "Dimension", accept: function (e) {
            ...
            var i = this.fround(e, this.value), n = String(i);
            ...
            var n = this._operate(e, t, this.value, i.value), r = this.unit.clone();
            if ("+" === t || "-" === t) if (0 === r.numerator.length && 0 === r.denominator.length) r = i.unit.clone(), this.unit.backupUnit && (r.backupUnit = this.unit.backupUnit); else if (0 === i.unit.numerator.length && 0 === r.denominator.length) ; else {
            ...
            var t, i, n, r, s, o = this.value, l = this.unit.clone(), u = {};
            if ("string" == typeof e) {
    ...
    Se.prototype = Object.assign(new u, {
        type: "Operation", accept: function (e) {
            ...
            var t, i = this.operands[0].eval(e), n = this.operands[1].eval(e);
            if (e.isMathOn(this.op)) {
                if (t = "./" === this.op ? "/" : this.op, i instanceof we && n instanceof c && (i = i.toColor()), n instanceof we && i instanceof c && (n = n.toColor()), !i.operate || !n.operate) {
                    if ((i instanceof Se || n instanceof Se) && "/" === i.op && e.math === xe.PARENS_DIVISION) return new Se(this.op, [i, n], this.isSpaced);
    ...
    Ce.prototype = Object.assign(new u, {
        type: "Expression", accept: function (e) {
            ...
            var t, i = e.isMathOn(), n = this.parens, r = !1;
            return n && e.inParenthesis(), this.value.length > 1 ? t = new Ce(this.value.map((function (t) {
                return t.eval ? t.eval(e) : t
            })), this.noSpacing) : 1 === this.value.length ? (!this.value[0].parens || this.value[0].parensInOp || e.inCalc || (r = !0), t = this.value[0].eval(e)) : t = this, n && e.outOfParenthesis(), !this.parens || !this.parensInOp || i || r || t instanceof we || (t = new p(t)), t
        }, genCSS: function (e, t) {
        ...
        return e.prototype.isValid = function () {
            ...
            return e = e.filter(n).map((function (e) {
                if ("Expression" === e.type) {
                    ...
                    return 1 === t.length ? e.parens && "/" === t[0].op ? e : t[0] : new Ce(t)
                }
                return e
    ...
    _e.prototype = Object.assign(new u, {
        type: "Call", accept: function (e) {
            ...
            if (null != n) return n instanceof u || (n = new le(n && !0 !== n ? n.toString() : null)), n._index = this._index, n._fileInfo = this._fileInfo, n;
    ...
    Ae.prototype = Object.assign(new u, {
        type: "Variable", eval: function (e) {
            var t, i = this.name;
            if (0 === i.indexOf("@@") && (i = "@" + new Ae(i.slice(1), this.getIndex(), this.fileInfo()).eval(e).value), this.evaluating) throw {
                type: "Name",
            ...
            if (this.evaluating = !0, t = this.find(e.frames, (function (t) {
                ...
                if (n) {
                    ...
                    return e.inCalc ? new _e("_SELF", [n.value]).eval(e) : n.value.eval(e)
                }
    ...
    Pe.prototype = Object.assign(new u, {
        type: "Property", eval: function (e) {
            var t, i = this.name, n = e.pluginManager.less.visitors.ToCSSVisitor.prototype._mergeRules;
            ...
            if (this.evaluating = !0, t = this.find(e.frames, (function (t) {
                ...
                if (s) {
                    for (var o = 0; o < s.length; o++) r = s[o], s[o] = new ce(r.name, r.value, r.important, r.merge, r.index, r.currentFileInfo, r.inline, r.variable);
    ...
    Me.prototype = Object.assign(new u, {
        type: "Attribute", eval: function (e) {
            return new Me(this.key.eval ? this.key.eval(e) : this.key, this.op, this.value && this.value.eval ? this.value.eval(e) : this.value, this.cif)
        }, genCSS: function (e, t) {
            t.add(this.toCSS(e))
        }, toCSS: function (e) {
            var t = this.key.toCSS ? this.key.toCSS(e) : this.key;
            return this.op && (t += this.op, t += this.value.toCSS ? this.value.toCSS(e) : this.value), this.cif && (t = t + " " + this.cif), "[" + t + "]"
        }
    });
    var Ee = function (e, t, i, n, r) {
        this.escaped = void 0 === i || i, this.value = t || "", this.quote = e.charAt(0), this._index = n, this._fileInfo = r, this.variableRegex = /@\{([\w-]+)\}/g, this.propRegex = /\$\{([\w-]+)\}/g, this.allowRoot = i
    };
    Ee.prototype = Object.assign(new u, {
        type: "Quoted", genCSS: function (e, t) {
            this.escaped || t.add(this.quote, this.fileInfo(), this.getIndex()), t.add(this.value), this.escaped || t.add(this.quote)
        }, containsVariables: function () {
            return this.value.match(this.variableRegex)
        }, eval: function (e) {
            var t = this, i = this.value;
            ...
            return i = n(i, this.variableRegex, (function (i, n) {
                ...
                return r instanceof Ee ? r.value : r.toCSS()
            })), new Ee(this.quote + i + this.quote, i, this.escaped, this.getIndex(), this.fileInfo())
        }, compare: function (e) {
    ...
    var Oe = {
        isRulesetLike: function () {
            ...
            if (e.mediaBlocks.length > 1) {
                var i = new se([], null, null, this.getIndex(), this.fileInfo()).createEmptySelectors();
                (t = new me(i, e.mediaBlocks)).multiMedia = !0, t.copyVisibilityInfo(this.visibilityInfo()), this.setParent(t, this)
            }
            return delete e.mediaBlocks, delete e.mediaPath, t
        }, evalNested: function (e) {
            var t, i, n = e.mediaPath.concat([this]);
            for (t = 0; t < n.length; t++) i = n[t].features instanceof oe ? n[t].features.value : n[t].features, n[t] = Array.isArray(i) ? i : [i];
            return this.features = new oe(this.permute(n).map((function (e) {
                for (e = e.map((function (e) {
                    return e.toCSS ? e : new le(e)
                })), t = e.length - 1; t > 0; t--) e.splice(t, 0, new le("and"));
                return new Ce(e)
            }))), this.setParent(this.features, this), new me([], [])
        }, permute: function (e) {
            if (0 === e.length) return [];
            if (1 === e.length) return e[0];
            for (var t = [], i = this.permute(e.slice(1)), n = 0; n < i.length; n++) for (var r = 0; r < e[0].length; r++) t.push([e[0][r]].concat(i[n]));
            return t
        }, bubbleSelectors: function (e) {
            e && (this.rules = [new me(k(e), [this.rules[0]])], this.setParent(this.rules, this))
        }
    }, Ve = function (e, t, i, n, r) {
        this._index = i, this._fileInfo = n;
        var s = new se([], null, null, this._index, this._fileInfo).createEmptySelectors();
        this.features = new oe(t), this.rules = [new me(s, e)], this.rules[0].allowImports = !0, this.copyVisibilityInfo(r), this.allowRoot = !0, this.setParent(s, this), this.setParent(this.features, this), this.setParent(this.rules, this)
    };
    Ve.prototype = Object.assign(new ge, Ie(Ie({type: "Media"}, Oe), {
        genCSS: function (e, t) {
            ...
            var t = new Ve(null, [], this._index, this._fileInfo, this.visibilityInfo());
    ...
    Fe.prototype = Object.assign(new u, {
        type: "Import", accept: function (e) {
            ...
            var e = this.path;
            return e instanceof Re && (e = e.value), !(e instanceof Ee) || e.containsVariables()
        }, evalForImport: function (e) {
            var t = this.path;
            return t instanceof Re && (t = t.value), new Fe(t.eval(e), this.features, this.options, this._index, this._fileInfo, this.visibilityInfo())
        }, evalPath: function (e) {
            var t = this.path.eval(e), i = this._fileInfo;
            if (!(t instanceof Re)) {
                var n = t.value;
            ...
            if (this.options.isPlugin) {
                if (this.root && this.root.eval) try {
                    ...
                    throw e.message = "Plugin error during evaluation", new V(e, this.root.imports, this.root.filename)
                }
            ...
            return this.root ? ((t = new me(null, k(this.root.rules))).evalImports(e), this.features ? new Ve(t.rules, this.features.value) : t.rules) : []
        }
    });
    var $e = function () {
    };
    ...
    Le.prototype = Object.assign(new $e, {
        type: "JavaScript", eval: function (e) {
            var t = this.evaluateJavaScript(this.expression, e), i = typeof t;
            return "number" !== i || isNaN(t) ? "string" === i ? new Ee('"' + t + '"', t, this.escaped, this._index) : Array.isArray(t) ? new le(t.join(", ")) : new le(t) : new we(t)
        }
    });
    var je = function (e, t) {
    ...
    var De = function (e, t, i, n, r, s) {
        this.op = e.trim(), this.lvalue = t, this.mvalue = i, this.op2 = n ? n.trim() : null, this.rvalue = r, this._index = s
    };
    De.prototype = Object.assign(new u, {
        type: "QueryInParens", accept: function (e) {
            this.lvalue = e.visit(this.lvalue), this.mvalue = e.visit(this.mvalue), this.rvalue && (this.rvalue = e.visit(this.rvalue))
        }, eval: function (e) {
            return this.lvalue = this.lvalue.eval(e), this.mvalue = this.mvalue.eval(e), this.rvalue && (this.rvalue = this.rvalue.eval(e)), this
        }, genCSS: function (e, t) {
            this.lvalue.genCSS(e, t), t.add(" " + this.op + " "), this.mvalue.genCSS(e, t), this.rvalue && (t.add(" " + this.op2 + " "), this.rvalue.genCSS(e, t))
        }
    });
    ...
    Be.prototype = Object.assign(new ge, Ie(Ie({type: "Container"}, Oe), {
        genCSS: function (e, t) {
            t.add("@container ", this._fileInfo, this._index), this.features.genCSS(e, t), this.outputRuleset(e, t, this.rules)
        }, eval: function (e) {
            e.mediaBlocks || (e.mediaBlocks = [], e.mediaPath = []);
            var t = new Be(null, [], this._index, this._fileInfo, this.visibilityInfo());
            return this.debugInfo && (this.rules[0].debugInfo = this.debugInfo, t.debugInfo = this.debugInfo), t.features = this.features.eval(e), e.mediaPath.push(t), e.mediaBlocks.push(t), this.rules[0].functionRegistry = e.frames[0].functionRegistry.inherit(), e.frames.unshift(this.rules[0]), t.rules = [this.rules[0].eval(e)], e.frames.shift(), e.mediaPath.pop(), 0 === e.mediaPath.length ? t.evalTop(e) : t.evalNested(e)
        }
    }));
    var Ue = function (e) {
    ...
    qe.prototype = Object.assign(new u, {
        type: "Negative", genCSS: function (e, t) {
            t.add("-"), this.value.genCSS(e, t)
        }, eval: function (e) {
            return e.isMathOn() ? new Se("*", [new we(-1), this.value]).eval(e) : new qe(this.value.eval(e))
        }
    });
    var Te = function (e, t, i, n, r) {
        switch (this.selector = e, this.option = t, this.object_id = Te.next_id++, this.parent_ids = [this.object_id], this._index = i, this._fileInfo = n, this.copyVisibilityInfo(r), this.allowRoot = !0, t) {
            case"all":
    ...
    Te.prototype = Object.assign(new u, {
        type: "Extend", accept: function (e) {
            ...
            return new Te(this.selector.eval(e), this.option, this.getIndex(), this.fileInfo(), this.visibilityInfo())
        }, clone: function (e) {
            return new Te(this.selector, this.option, this.getIndex(), this.fileInfo(), this.visibilityInfo())
            ...
            this.selfSelectors = [new se(n)], this.selfSelectors[0].copyVisibilityInfo(this.visibilityInfo())
        }
    }), Te.next_id = 0;
    ...
    ze.prototype = Object.assign(new u, {
        type: "VariableCall", eval: function (e) {
            var t, i = new Ae(this.variable, this.getIndex(), this.fileInfo()).eval(e),
                n = new V({message: "Could not evaluate variable call " + this.variable});
            if (!i.ruleset) {
                if (i.rules) t = i; else if (Array.isArray(i)) t = new me("", i); else {
    ...
    Ge.prototype = Object.assign(new u, {
        type: "NamespaceValue", eval: function (e) {
            var t, i, n = this.value.eval(e);
            for (t = 0; t < this.lookups.length; t++) {
                if (i = this.lookups[t], Array.isArray(n) && (n = new me([new se], n)), "" === i) n = n.lastDeclaration(); else if ("@" === i.charAt(0)) {
                    if ("@" === i.charAt(1) && (i = "@" + new Ae(i.substr(1)).eval(e).value), n.variables && (n = n.variable(i)), !n) throw {
                        type: "Name",
                    ...
                    if (i = "$@" === i.substring(0, 2) ? "$" + new Ae(i.substr(1)).eval(e).value : "$" === i.charAt(0) ? i : "$" + i, n.properties && (n = n.property(i)), !n) throw {
                        type: "Name",
    ...
    var We = function (e, t, i, n, r, s, o) {
        this.name = e || "anonymous mixin", this.selectors = [new se([new m(null, e, !1, this._index, this._fileInfo)])], this.params = t, this.condition = n, this.variadic = r, this.arity = t.length, this.rules = i, this._lookups = {};
        var a = [];
    ...
    We.prototype = Object.assign(new me, {
        type: "MixinDefinition", evalFirst: !0, accept: function (e) {
            ...
            var r, s, o, a, l, u, c, h, f = new me(null, null), p = k(this.params), v = 0;
            if (t.frames && t.frames[0] && t.frames[0].functionRegistry && (f.functionRegistry = t.frames[0].functionRegistry.inherit()), t = new D.Eval(t, [f].concat(t.frames)), i) for (v = (i = k(i)).length, o = 0; o < v; o++) if (u = (s = i[o]) && s.name) {
                for (c = !1, a = 0; a < p.length; a++) if (!n[a] && u === p[a].name) {
                    n[a] = s.value.eval(e), f.prependRule(new ce(u, s.value.eval(e))), c = !0;
                    break
                }
                if (c) {
                    i.splice(o, 1), o--;
                ...
                throw {type: "Runtime", message: "Named argument for " + this.name + " " + i[o].name + " not found"}
            }
            for (h = 0, o = 0; o < p.length; o++) if (!n[o]) {
                if (s = i && i[h], u = p[o].name) if (p[o].variadic) {
                    for (r = [], a = h; a < v; a++) r.push(i[a].value.eval(e));
                    f.prependRule(new ce(u, new Ce(r).eval(e)))
                } else {
                    if (l = s && s.value) l = Array.isArray(l) ? new ye(new me("", l)) : l.eval(e); else {
                        if (!p[o].value) throw {
                            type: "Runtime",
            ...
            return new We(this.name, this.params, e, this.condition, this.variadic, this.frames)
        }, eval: function (e) {
            return new We(this.name, this.params, this.rules, this.condition, this.variadic, this.frames || k(e.frames))
        }, evalCall: function (e, t, i) {
            var n, r, s = [], o = this.frames ? this.frames.concat(e.frames) : e.frames,
                a = this.evalParams(e, new D.Eval(e, o), t, s);
            return a.prependRule(new ce("@arguments", new Ce(s).eval(e))), n = k(this.rules), (r = new me(null, n)).originalRuleset = this, r = r.eval(new D.Eval(e, [this, a].concat(o))), i && (r = r.makeImportant()), r
        }, matchCondition: function (e, t) {
            return !(this.condition && !this.condition.eval(new D.Eval(t, [this.evalParams(t, new D.Eval(t, this.frames ? this.frames.concat(t.frames) : t.frames), e, [])].concat(this.frames || []).concat(t.frames))))
        }, matchArgs: function (e, t) {
            var i, n = e && e.length || 0, r = this.optionalParameters, s = e ? e.reduce((function (e, t) {
            ...
            for (var o = 0; o < i; o++) if (!this.params[o].name && !this.params[o].variadic && e[o].value.eval(t).toCSS() != this.params[o].value.eval(t).toCSS()) return !1;
            return !0
        }
    });
    var Je = function (e, t, i, n, r) {
        this.selector = new se(e), this.arguments = t || [], this._index = i, this._fileInfo = n, this.important = r, this.allowRoot = !0, this.setParent(this.selector, this)
    };
    Je.prototype = Object.assign(new u, {
        type: "MixinCall", accept: function (e) {
            ...
            var t, i, n, r, s, o, a, l, u, c, h, f, p, v, d, m = [], g = [], y = !1, b = [], w = [];

            function x(t, i) {
                var n, r, s;
                for (n = 0; n < 2; n++) {
                    for (w[n] = !0, de.value(n), r = 0; r < i.length && w[n]; r++) (s = i[r]).matchCondition && (w[n] = w[n] && s.matchCondition(null, e));
                    t.matchCondition && (w[n] = w[n] && t.matchCondition(m, e))
                }
                return w[0] || w[1] ? w[0] != w[1] ? w[1] ? 1 : 2 : 0 : -1
            }

            for (this.selector = this.selector.eval(e), o = 0; o < this.arguments.length; o++) if (s = (r = this.arguments[o]).value.eval(e), r.expand && Array.isArray(s.value)) for (s = s.value, a = 0; a < s.length; a++) m.push({value: s[a]}); else m.push({
                name: r.name,
                value: s
            });
            for (d = function (t) {
                return t.matchArgs(null, e)
            }, o = 0; o < e.frames.length; o++) if ((t = e.frames[o].find(this.selector, null, d)).length > 0) {
                for (c = !0, a = 0; a < t.length; a++) {
                    for (i = t[a].rule, n = t[a].path, u = !1, l = 0; l < e.frames.length; l++) if (!(i instanceof We) && i === (e.frames[l].originalRuleset || e.frames[l])) {
                        u = !0;
                        break
                    }
                    u || i.matchArgs(m, e) && (-1 !== (h = {mixin: i, group: x(i, n)}).group && b.push(h), y = !0)
                }
                for (de.reset(), p = [0, 0, 0], a = 0; a < b.length; a++) p[b[a].group]++;
                ...
                for (a = 0; a < b.length; a++) if (0 === (h = b[a].group) || h === f) try {
                    (i = b[a].mixin) instanceof We || (v = i.originalRuleset || i, (i = new We("", [], i.rules, null, !1, null, v.visibilityInfo())).originalRuleset = v);
    ...
    var He = {
        ...
        return e.prototype.getPath = function (e) {
            ...
            var i, n, r, s, o = this.extractUrlParts(e), a = this.extractUrlParts(t), l = "";
            ...
            if (s[3]) for (a = s[3].replace(/\\/g, "/").split("/"), i = 0; i < a.length; i++) ".." === a[i] ? l.pop() : "." !== a[i] && l.push(a[i]);
        ...
        return e.prototype.evalPlugin = function (e, t, i, n, r) {
            ...
            if (u && (o = l.get(u))) {
                ...
                try {
                    ...
                    return e.message = e.message || "Error during @plugin call", new V(e, i, u)
                }
                return o
            }
            a = {exports: {}, pluginManager: l, fileInfo: r}, s = te.create();
            try {
            ...
            if (o || (o = a.exports), (o = this.validatePlugin(o, u, h)) instanceof V) return o;
            ...
            if (n && !e.setOptions) return new V({message: "Options have been provided but the plugin " + i + " does not support any options."});
            try {
            ...
            return e ? ("function" == typeof e && (e = new e), e.minVersion && this.compareVersion(e.minVersion, this.less.version) < 0 ? new V({message: "Plugin " + i + " requires version " + this.versionToString(e.minVersion)}) : e) : null
        }, e.prototype.compareVersion = function (e, t) {
            "string" == typeof e && (e = e.match(/^(\d+)\.?(\d+)?\.?(\d+)?/)).shift();
            for (var i = 0; i < e.length; i++) if (e[i] !== t[i]) return parseInt(e[i]) > parseInt(t[i]) ? -1 : 1;
            return 0
    ...
    var Ye, et = {
        isdefined: Xe, boolean: function (e) {
    ...
    function st(e) {
        if (e instanceof we) return parseFloat(e.unit.is("%") ? e.value / 100 : e.value);
    ...
    var ot = Ye = {
        rgb: function (e, t, i) {
            ...
            try {
                if (e instanceof c) return n = t ? st(t) : e.alpha, new c(e.rgb, n, "rgba");
                var r = [e, t, i].map((function (e) {
                    return i = 255, (t = e) instanceof we && t.unit.is("%") ? parseFloat(t.value * i / 100) : st(t);
                    var t, i
                }));
            ...
            try {
                if (e instanceof c) return n = t ? st(t) : e.alpha, new c(e.rgb, n, "hsla");
                e = st(e) % 360 / 360, t = tt(st(t)), i = tt(st(i)), n = tt(st(n)), r = 2 * i - (s = i <= .5 ? i * (t + 1) : i + t - i * t);
            ...
            var n = nt(e);
            return void 0 !== i && "relative" === i.value ? n.s += n.s * t.value / 100 : n.s += t.value / 100, n.s = tt(n.s), it(e, n)
        }, desaturate: function (e, t, i) {
            var n = nt(e);
            return void 0 !== i && "relative" === i.value ? n.s -= n.s * t.value / 100 : n.s -= t.value / 100, n.s = tt(n.s), it(e, n)
        }, lighten: function (e, t, i) {
            var n = nt(e);
            return void 0 !== i && "relative" === i.value ? n.l += n.l * t.value / 100 : n.l += t.value / 100, n.l = tt(n.l), it(e, n)
        }, darken: function (e, t, i) {
            var n = nt(e);
            return void 0 !== i && "relative" === i.value ? n.l -= n.l * t.value / 100 : n.l -= t.value / 100, n.l = tt(n.l), it(e, n)
        }, fadein: function (e, t, i) {
            var n = nt(e);
            return void 0 !== i && "relative" === i.value ? n.a += n.a * t.value / 100 : n.a += t.value / 100, n.a = tt(n.a), it(e, n)
            ...
            var i = nt(e), n = (i.h + t.value) % 360;
            return i.h = n < 0 ? 360 + n : n, it(e, i)
        }, mix: function (e, t, i) {
            i || (i = new we(50));
            var n = i.value / 100, r = 2 * n - 1, s = nt(e).a - nt(t).a,
                o = ((r * s == -1 ? r : (r + s) / (1 + r * s)) + 1) / 2, a = 1 - o,
            ...
            if (!e.rgb) return null;
            if (void 0 === i && (i = Ye.rgba(255, 255, 255, 1)), void 0 === t && (t = Ye.rgba(0, 0, 0, 1)), t.luma() > i.luma()) {
                var r = i;
                i = t, t = r
            }
            return n = void 0 === n ? .43 : st(n), e.luma() < n ? i : t
        }, argb: function (e) {
            return new le(e.toARGB())
        }, color: function (e) {
            if (e instanceof Ee && /^#([A-Fa-f0-9]{8}|[A-Fa-f0-9]{6}|[A-Fa-f0-9]{3,4})$/i.test(e.value)) {
    ...
    function at(e, t, i) {
        var n, r, s, o, a = t.alpha, l = i.alpha, u = [];
        s = l + a * (1 - l);
    ...
    var ct = function (e) {
        ...
        _SELF: function (e) {
            ...
            var i, n, r = this, s = [], o = function (e) {
                return e instanceof u ? e.eval(r.context) : e
            };
            n = !e.value || e instanceof Ee ? e.ruleset ? o(e.ruleset).rules : e.rules ? e.rules.map(o) : Array.isArray(e) ? e.map(o) : [o(e)] : Array.isArray(e.value) ? e.value.map(o) : [o(e.value)];
            var a = "@value", l = "@key", c = "@index";
            ...
            for (var h = 0; h < n.length; h++) {
                var f = void 0, p = void 0, v = n[h];
                v instanceof ce ? (f = "string" == typeof v.name ? v.name : v.name[0].value, p = v.value) : (f = new we(h + 1), p = v), v instanceof ve || (i = t.rules.slice(0), a && i.push(new ce(a, p, !1, !1, this.index, this.currentFileInfo)), c && i.push(new ce(c, new we(h + 1), !1, !1, this.index, this.currentFileInfo)), l && i.push(new ce(l, f, !1, !1, this.index, this.currentFileInfo)), s.push(new me([new se([new m("", "&")])], i, t.strictImports, t.visibilityInfo())))
            }
            return new me([new se([new m("", "&")])], s, t.strictImports, t.visibilityInfo()).eval(this.context)
        }
    }, ft = function (e, t, i) {
        if (!(i instanceof we)) throw {type: "Argument", message: "argument must be a number"};
        return null === t ? t = i.unit : i = i.unify(), new we(e(parseFloat(i.value)), t)
    }, pt = {
        ceil: null,
        floor: null,
        sqrt: null,
    ...
    for (var vt in pt) pt.hasOwnProperty(vt) && (pt[vt] = ft.bind(null, Math[vt], pt[vt]));
    ...
    var dt = function (e, t) {
        ...
        })).join(this.context.compress ? "," : ", "), new le((e ? "min" : "max") + "(" + t + ")"))
    }, mt = {
        min: function () {
            for (var e = [], t = 0; t < arguments.length; t++) e[t] = arguments[t];
            try {
            ...
            if ("number" == typeof e && "number" == typeof t) e = new we(e), t = new we(t); else if (!(e instanceof we && t instanceof we)) throw {
                type: "Argument",
        ...
        e: function (e) {
            ...
            return new le(encodeURI(e.value).replace(/=/g, "%3D").replace(/:/g, "%3A").replace(/#/g, "%23").replace(/;/g, "%3B").replace(/\(/g, "%28").replace(/\)/g, "%29"))
        }, replace: function (e, t, i, n) {
            var r = e.value;
            return i = "Quoted" === i.type ? i.value : i.toCSS(), r = r.replace(new RegExp(t.value, n ? n.value : ""), i), new Ee(e.quote || "", r, e.escaped)
        }, "%": function (e) {
        ...
        isruleset: function (e) {
            ...
            return bt(e, "em")
        }, isunit: bt, unit: function (e, t) {
            if (!(e instanceof we)) throw {
                type: "Argument",
                message: "the first argument to unit must be a number" + (e instanceof Se ? ". Have you forgotten parenthesis?" : "")
            };
            return t = t ? t instanceof ae ? t.value : t.toCSS() : "", new we(e.value, t)
        }, "get-unit": function (e) {
            return new le(e.unit)
        }
    }, xt = function (e) {
        var t = {functionRegistry: te, functionCaller: ke};
        return te.addMultiple(et), te.add("default", de.eval.bind(de)), te.addMultiple(ot), te.addMultiple(at), te.addMultiple(function (e) {
            var t = function (e, t) {
            ...
            return {
                "data-uri": function (i, n) {
                    n || (n = i, i = null);
                    var s = i && i.value, o = n.value, a = this.currentFileInfo,
                        l = a.rewriteUrls ? a.currentDirectory : a.entryPath, u = o.indexOf("#"), c = "";
                    ...
                    var p = !1;
                    if (i) p = /;base64$/.test(s); else {
                        if ("image/svg+xml" === (s = e.mimeLookup(o))) p = !1; else {
                    ...
                    return new Re(new Ee('"' + g + '"', g, !1, this.index, this.currentFileInfo), this.index, this.currentFileInfo)
                }
            }
        }(e)), te.addMultiple(ht), te.addMultiple(pt), te.addMultiple(mt), te.addMultiple(gt), te.addMultiple({
            "svg-gradient": function (e) {
                var t, i, n, r, s, o, a, l, u = "linear", h = 'x="0" y="0" width="1" height="1"', f = {compress: !1},
                    p = e.toCSS(f);
                ...
                for (n = '<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 1 1"><' + u + 'Gradient id="g" ' + i + ">", r = 0; r < t.length; r += 1) t[r] instanceof Ce ? (s = t[r].value[0], o = t[r].value[1]) : (s = t[r], o = void 0), s instanceof c && ((0 === r || r + 1 === t.length) && void 0 === o || o instanceof we) || v(), a = o ? o.toCSS(f) : 0 === r ? "0%" : "100%", l = s.alpha, n += '<stop offset="' + a + '" stop-color="' + s.toRGB() + '"' + (l < 1 ? ' stop-opacity="' + l + '"' : "") + "/>";
                return n += "</" + u + "Gradient><rect " + h + ' fill="url(#g)" /></svg>', n = encodeURIComponent(n), new Re(new Ee("'" + (n = "data:image/svg+xml," + n) + "'", n, !1, this.index, this.currentFileInfo), this.index, this.currentFileInfo)
            }
        }), te.addMultiple(wt), t
    };

    function St(e, t) {
        var i, n = (t = t || {}).variables, r = new D.Eval(t);
        "object" != typeof n || Array.isArray(n) || (n = Object.keys(n).map((function (e) {
            var t = n[e];
            return t instanceof He.Value || (t instanceof He.Expression || (t = new He.Expression([t])), t = new He.Value([t])), new He.Declaration("@" + e, t, !1, null, 0)
        })), r.frames = [new He.Ruleset(null, n)]);
        var s, o,
            a = [new Y.JoinSelectorVisitor, new Y.MarkVisibleSelectorsVisitor(!0), new Y.ExtendVisitor, new Y.ToCSSVisitor({compress: Boolean(t.compress)})],
            l = [];
        if (t.pluginManager) {
            o = t.pluginManager.visitor();
            for (var u = 0; u < 2; u++) for (o.first(); s = o.get();) s.isPreEvalVisitor ? 0 !== u && -1 !== l.indexOf(s) || (l.push(s), s.run(e)) : 0 !== u && -1 !== a.indexOf(s) || (s.isPreVisitor ? a.unshift(s) : a.push(s))
        }
        i = e.eval(r);
        for (var c = 0; c < a.length; c++) a[c].run(i);
        if (t.pluginManager) for (o.first(); s = o.get();) -1 === a.indexOf(s) && -1 === l.indexOf(s) && s.run(i);
        return i
    }
    ...
    function Mt(e, t) {
        ...
        o = function (e) {
            return function () {
                ...
                return t.prototype.toCSS = function (t) {
                    ...
                    if (t.pluginManager) for (var l = t.pluginManager.getPostProcessors(), u = 0; u < l.length; u++) s.css = l[u].process(s.css, {
                        sourceMap: n,
                        options: t,
                        imports: this.imports
                    });
                    for (var c in t.sourceMap && (s.map = n.getExternalSourceMap()), s.imports = [], this.imports.files) Object.prototype.hasOwnProperty.call(this.imports.files, c) && c !== this.imports.rootFilename && s.imports.push(c);
                    return s
                }, t
            }()
        }(n = function (e, t) {
            ...
            return function () {
                ...
                return t.prototype.removeBasepath = function (e) {
                    ...
                    if (e) {
                        ...
                        if (o = (r = e.split("\n"))[r.length - 1], t && t.filename) if (n) for (l = 0; l < r.length; l++) this._sourceMapGenerator.addMapping({
                            generated: {
                            ...
                            generated: {
                                ...
                                column: this._column
                            }, original: {line: s.length, column: a.length}, source: this.normalizeFilename(t.filename)
                        });
                    ...
                    if (this._rootNode.genCSS(e, this), this._css.length > 0) {
                        var n = void 0, r = JSON.stringify(this._sourceMapGenerator.toJSON());
            ...
            return function () {
                ...
                return t.prototype.push = function (t, i, n, s, o) {
                    var a = this, l = this.context.pluginManager.Loader;
                    this.queue.push(t);
                    var u = function (e, i, n) {
                        a.queue.splice(a.queue.indexOf(t), 1);
                        var l = n === a.rootFilename;
                        s.optional && e ? (o(null, {rules: []}, !1, null), r.info("The file " + n + " was skipped because it was not found and the import was marked optional.")) : (a.files[n] || s.inline || (a.files[n] = {
                            root: i,
                            options: s
                    ...
                    if (h) {
                        var f, p, v = function (e) {
                            var t, i = e.filename, r = e.contents.replace(/^\uFEFF/, "");
                            ...
                            o.processImports = !1, a.contents[i] = r, (n.reference || s.reference) && (c.reference = !0), s.isPlugin ? (t = l.evalPlugin(r, o, a, s.pluginArgs, c)) instanceof V ? u(t, null, i) : u(null, t, i) : s.inline ? u(null, r, i) : !a.files[i] || a.files[i].options.multiple || s.multiple ? new re(o, a, c).parse(r, (function (e, t) {
                                u(e, t, i)
        ...
        var u, c = function (e, t) {
            var i = function (e, n, r) {
                if ("function" == typeof n ? (r = n, n = P(this.options, {})) : n = P(this.options, n || {}), !r) {
                    var s = this;
            ...
            var n = function (e, t, r) {
                ...
                var o, a = void 0, l = new kt(this, !t.reUsePluginManager);
                if (t.pluginManager = l, o = new D.Parse(t), t.rootFileInfo) a = t.rootFileInfo; else {
                ...
                this.importManager = h, t.plugins && t.plugins.forEach((function (e) {
                    var t, i;
                    if (e.fileContent) {
                        if (i = e.fileContent.replace(/^\uFEFF/, ""), (t = l.Loader.evalPlugin(i, o, h, e.options, e.filename)) instanceof V) return r(t)
                    } else l.addPlugin(e)
                })), new re(o, h, a).parse(e, (function (e, i) {
                    if (e) return r(e);
                    r(null, i, h, t)
                }), t)
            };
        ...
        for (var m in p.tree) if ("function" == typeof (u = p.tree[m])) d[m.toLowerCase()] = v(u); else for (var g in d[m] = Object.create(null), u) d[m][g.toLowerCase()] = v(u[g]);
    ...
    Rt.prototype = Object.assign(new Qe, {
        alwaysMakePathsAbsolute: function () {
            ...
            var r = new XMLHttpRequest, s = !_t.isFileProtocol || _t.fileAsync;
            ...
            var n = this.extractUrlParts(e, window.location.href).url, r = this;
            return new Promise((function (e, t) {
                if (i.useFileCache && Et[n]) try {
                    var s = Et[n];
                    return e({contents: s, filename: n, webInfo: {lastModified: new Date}})
                } catch (e) {
                    return t({filename: n, message: "Error loading file " + n + " error was " + e.message})
                }
                r.doXHR(n, i.mime, (function (t, i) {
                    Et[n] = t, e({contents: t, filename: n, webInfo: {lastModified: i}})
                }), (function (e, i) {
                    t({type: "File", message: "'" + i + "' wasn't found (" + e + ")", href: n})
                }))
            }))
        }
    });
        ...
        return {
            add: function (s, o) {
                r.errorReporting && "html" !== r.errorReporting ? "console" === r.errorReporting ? function (e, t) {
                    ...
                    var o, a, l = "less-error-message:" + e(s || ""), u = t.document.createElement("div"), c = [],
                        h = n.filename || s, f = h.match(/([^/]+(\?.*)?)$/)[1];
                    ...
                    n.line && (p(n, 0, ""), p(n, 1, "line"), p(n, 2, ""), a += "on line " + n.line + ", column " + (n.column + 1) + ":</p><ul>" + c.join("") + "</ul>"), n.stack && (n.extract || r.logLevel >= 4) && (a += "<br/>Stack Trace</br />" + n.stack.split("\n").slice(1).join("<br/>")), u.innerHTML = a, i(t.document, [".less-error-message ul, .less-error-message li {", "list-style-type: none;", "margin-right: 15px;", "padding: 4px 0;", "margin: 0;", "}", ".less-error-message label {", "font-size: 12px;", "margin-right: 15px;", "padding: 4px 0;", "color: #cc7777;", "}", ".less-error-message pre {", "color: #dd6666;", "padding: 4px 0;", "margin: 0;", "display: inline-block;", "}", ".less-error-message pre.line {", "color: #ff0000;", "}", ".less-error-message h3 {", "font-size: 20px;", "font-weight: bold;", "padding: 15px 0 5px 0;", "margin: 0;", "}", ".less-error-message a {", "color: #10a", "}", ".less-error-message .error {", "color: red;", "font-weight: bold;", "padding-bottom: 2px;", "border-bottom: 1px dashed red;", "}"].join("\n"), {title: "error-message"}), u.style.cssText = ["font-family: Arial, sans-serif", "border: 1px solid #e00", "background-color: #eee", "border-radius: 5px", "-webkit-border-radius: 5px", "-moz-border-radius: 5px", "color: #e00", "padding: 15px", "margin-bottom: 15px"].join(";"), "development" === r.env && (o = setInterval((function () {
                        var e = t.document, i = e.body;
    ...
    if (window.less) for (var Lt in window.less) Object.prototype.hasOwnProperty.call(window.less, Lt) && ($t[Lt] = window.less[Lt]);
    !function (e, i) {
    ...
    }(window, $t), $t.plugins = $t.plugins || [], window.LESS_PLUGINS && ($t.plugins = $t.plugins.concat(window.LESS_PLUGINS));
    var jt, Nt, Dt, Bt = function (e, n) {
        var r = e.document, s = Mt();
        s.options = n;
        var o = s.environment, a = Ot(n, s.logger), l = new a;
        o.addFileManager(l), s.FileManager = a, s.PluginLoader = Vt, function (e, t) {
        ...
        var u = Ft(e, s, n), c = s.cache = n.cache || function (e, t, i) {
            var n = null;
            ...
            return {
                setCSS: function (e, t, r, s) {
                    ...
                    var r = n && n.getItem(e), s = n && n.getItem(e + ":timestamp"), o = n && n.getItem(e + ":vars");
        ...
        function v(e) {
            for (var t, i = r.getElementsByTagName("style"), o = 0; o < i.length; o++) if ((t = i[o]).type.match(h)) {
                var a = f(n);
                a.modifyVars = e;
                var l = t.innerHTML || "";
        ...
        function d(e, i, r, a, h) {
            ...
            t(p, e), p.mime = e.type, h && (p.modifyVars = h), l.loadFile(e.href, null, p, o).then((function (t) {
                !function (t) {
                    var n = t.contents, o = t.filename, h = t.webInfo,
                        f = {currentDirectory: l.getPath(o), filename: o, rootFilename: o, rewriteUrls: p.rewriteUrls};
